        ...
        <div className="contacto-wrap">
          ...
          <div className="datos">
            ...
            <div className="dato"><b>SÍGUENOS · {CONTENIDO.contacto.redes.length} REDES</b>
              <div className="redes">{CONTENIDO.contacto.redes.map((r) => (<a className="red" key={r.nombre} href={r.href} target="_blank" rel="noreferrer" title={r.nombre}><svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d={r.svg} /></svg></a>))}</div>
            </div>
          </div>
        </div>
      </section>
